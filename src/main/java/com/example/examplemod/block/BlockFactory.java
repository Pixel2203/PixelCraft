...
public class BlockFactory {
    ...
    public static final Block WhiteChalkBlock_BLK = new Block(BlockBehaviour.Properties.copy(Blocks.CYAN_CARPET));
    ...
    public static final BlockItem WhiteChalkBlock_BLKITM = new BlockItem(BlockFactory.WhiteChalkBlock_BLK, new Item.Properties());
}
