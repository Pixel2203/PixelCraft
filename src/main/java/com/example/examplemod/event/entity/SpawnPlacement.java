...
public class SpawnPlacement {
    ...
    public static void onRegisterSpawnPlacement(SpawnPlacementRegisterEvent event){
        ...
        event.register(EntityRegistry.SOUL_ENTITY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, SoulEntity::canSpawn, SpawnPlacementRegisterEvent.Operation.OR);
    }
