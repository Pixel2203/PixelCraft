...
public abstract class MagicCircleProcessor {
     ...
     */
    public abstract RitualState process(RitualContext context, ServerLevel level, BlockState blockState, BlockPos blockPos, GoldenChalkBlockEntity blockEntity);



    protected RitualState cancelRitual(ServerLevel level, BlockPos blockPos, GoldenChalkBlockEntity blockEntity, RitualContext context) {
    ...
    protected RitualState resetToDefault(GoldenChalkBlockEntity blockEntity, RitualContext context) {
