...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<SoulWispEntity>> SOUL_WISP_ENTITY = ENTITIES.register("soul_wisp", () -> EntityType.Builder.of(SoulWispEntity::new, MobCategory.MISC).sized(1f, 1f).build(ExampleMod.MODID + ":soul_wisp"));
}
