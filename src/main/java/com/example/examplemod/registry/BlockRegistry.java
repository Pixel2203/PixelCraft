...
public class BlockRegistry {
    ...
    private static final RegistryObject<Block> ExampleBlock =
            BLOCKS.register("example_block",() -> BlockFactory.ExampleBlock_BLK);
    private static final RegistryObject<Block> ZirconBlock =
            BLOCKS.register("zircon_block",() -> BlockFactory.ZirconBlock_BLK);
    private static final RegistryObject<Block> CauldronCustomBlock =
            BLOCKS.register("cauldron_custom",() -> BlockFactory.CauldronCustomBlock_BLK);
    private static final RegistryObject<Block> GoldenChalkBlock =
            BLOCKS.register("golden_chalk",() -> BlockFactory.GoldenChalkBlock_BLK);
    private static final RegistryObject<Block> WhiteChalkBlock =
            BLOCKS.register("white_chalk",() -> BlockFactory.WhiteChalkBlock_BLK);

    private static final RegistryObject<BlockItem> ExampleBlockItem =
            ItemRegistry.ITEMS.register("example_block", () -> BlockFactory.ExampleBlock_BLKITM);
    private static final RegistryObject<BlockItem> ZirconBlockItem =
            ItemRegistry.ITEMS.register("zircon_block", () -> BlockFactory.ZirconBlock_BLKITM);
    private static final RegistryObject<BlockItem> CauldronCustomBlockItem =
