...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> UNDEAD_PROTECTION_TALISMAN = ITEMS.register("undead_protection_talisman", UndeadProtectionTalisman::new);
    public static final RegistryObject<Item> HEALING_SCROLL = ITEMS.register("healing_scroll", () -> new ScrollItem(Scrolls.HEALING_SCROLL));
    public static final RegistryObject<Item> PROJECTILE_BARRIER_SCROLL = ITEMS.register("projectile_barrier_scroll", () -> new ScrollItem(Scrolls.PROJECTILE_NULLIFIER_SCROLL));
    public static final RegistryObject<Item> CONFUSION_SCROLL = ITEMS.register("confusion_scroll", () -> new ScrollItem(Scrolls.CONFUSION_SCROLL));
